...
# controles_mudado = pygame.transform.scale(controles,(856 / 3,360/ 3))
# objetivo = pygame.image.load('objetivo.png')
# objetivo_mudado = pygame.transform.scale(objetivo,(856 ,360 ))
# instrucao = pygame.image.load('instrucao.png')
# instrucao_mudado = pygame.transform.scale(instrucao,(856/3 ,360/3))
# direita = [
...
# # Carrega a musica
# music = pygame.mixer.music.load('song.ogg')
...
#         if userInput[pygame.K_SPACE] and player.alive == False:
#             player.alive = True
#             player.lives = 1
#             player.health = 30
#             player.x = 200
...
#         for enemy in enemies:
#             enemy.move()
#             if enemy.off_screen() or enemy.health == 0 or player.alive == False:
...
#     screen.blit(controles_mudado,(-40,350))
#     screen.blit(objetivo_mudado,(320,300))
#     screen.blit(instrucao_mudado,(300,200))
#     for event in pygame.event.get():
#             if event.type == QUIT:
#                 pygame.quit()
#                 quit()

#     if userInput[pygame.K_SPACE] and player.alive == True:
#         play()
#     pygame.display.update()
